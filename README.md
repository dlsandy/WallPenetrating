...
```powershell
git clone https://github.com/dlsandy/Wall-Penetrating.git
cd Wall-Penetrating
```
...
├── install.ps1              # 安装向导
├── 开始使用.html            # 安装后快速入门页
├── manifest.json            # Chrome 扩展清单（当前 v2.11.0）
└── README.md
```
...
```powershell
git add .
git status   # 确认未包含 data/、native/com.anytls.singbox.json、*.rar
git commit -m "Initial release"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/Wall-Penetrating.git
